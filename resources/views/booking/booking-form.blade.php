...
<div
    x-init="() => {}"
    @click.away="openBookingForm = false; openBookingEditModal = false"
...
>
    ...
    >
        ...
        <div class="flex justify-end space-x-3">
            <button type="button" @click="openBookingForm = false; openBookingEditModal = false" class="px-4 py-2 rounded-md bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-100">Cancel</button>
